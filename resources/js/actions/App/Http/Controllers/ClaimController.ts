 ...
 * @see app/Http/Controllers/ClaimController.php:63
 * @route '/claims'
 */
 ...
 * @see app/Http/Controllers/ClaimController.php:352
 ...
 * @see app/Http/Controllers/ClaimController.php:565
 ...
 * @see app/Http/Controllers/ClaimController.php:456
 * @route '/claims/{claim}'
 */
 ...
 * @see app/Http/Controllers/ClaimController.php:583
 * @route '/claims/{claim}'
 */
...
const ClaimController = { index, options, activities, show, update }

            ...
            <CardContent className="p-4">
                <div className="grid gap-4 md:grid-cols-2">
                    <div className="bg-muted/10 rounded-lg border p-4">
                        <p className="text-muted-foreground text-xs font-semibold uppercase">Remaining {workspace.identifierLabel}s</p>
                        <p className="mt-1 text-2xl font-semibold">
                            {summary.claim_groups.toLocaleString()}{' '}
                            <span className="text-muted-foreground text-sm font-normal">
                                ({summary.claim_lines.toLocaleString()} {workspace.procedureLabel} lines)
                            </span>
                        </p>
                    ...
                    <div className="bg-muted/10 rounded-lg border p-4">
                        <p className="text-muted-foreground text-xs font-semibold uppercase">Assigned {workspace.identifierLabel}s</p>
                        <p className="mt-1 text-2xl font-semibold">
                            {summary.assigned_claim_groups.toLocaleString()}{' '}
                            <span className="text-muted-foreground text-sm font-normal">
                                ({summary.assigned_claim_lines.toLocaleString()} {workspace.procedureLabel} lines)
                            </span>
                        </p>
                        {workspace.showTrueBalance && (
                            <p className="text-muted-foreground mt-1 text-sm">
